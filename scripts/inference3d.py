...
if __name__ == "__main__":
    ...
    """
    model = torch.jit.load('/data/conradrw/mmm_base_model_optim_211119.pth')#.cuda()
    ...
    for axis_name, axis in axes.items():
        ...
        #inference_engine = engine_cls(model, pr_model, **config['INFERENCE']['engine_params'], device='cpu')
